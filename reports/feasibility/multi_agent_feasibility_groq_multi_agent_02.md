...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| groq_multi_agent_02 | groq | llama-3.1-8b-instant | baseline,stress_fraud | 2 | 4 | 16 | 16 | 0 | 13091 | 0.0007648 | 4.78e-05 | 2.7759 | 4 | 2 | 0.5 | 4084.32 | balanced_threshold | 24295.57 | balanced_threshold | 24295.57 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| baseline | 1 | balanced_threshold | 24295.57 | balanced_threshold | 24295.57 | 0.0 | balanced_threshold | 24295.57 | 0.0 | 4.446e-05 | -4.4e-05 |
| baseline | 2 | balanced_threshold | 24295.57 | balanced_threshold | 24295.57 | 0.0 | balanced_threshold | 24295.57 | 0.0 | 5.152e-05 | -5.2e-05 |
| stress_fraud | 1 | strict_threshold | 16126.93 | balanced_threshold | 24295.57 | 8168.64 | balanced_threshold | 24295.57 | -8168.64 | 4.946e-05 | -8168.640049 |
| stress_fraud | 2 | strict_threshold | 16126.93 | balanced_threshold | 24295.57 | 8168.64 | balanced_threshold | 24295.57 | -8168.64 | 4.38e-05 | -8168.640044 |

## 4. Interpretation

The live multi-agent pilot is technically feasible at small scale: all calls succeeded, latency was low, and token cost was negligible. It also shows early decision-value feasibility because the LLM policy-maker frequently selected the policy with the highest simulated net benefit. A larger experiment should test more scenarios and compare hybrid/full LLM agents against the rule-based baseline.
